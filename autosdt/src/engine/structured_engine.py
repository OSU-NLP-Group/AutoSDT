...
def azure_chat_engine(client, engine, msg, struct_format, temperature, top_p, max_tokens=20000):
    response = client.beta.chat.completions.parse(
        model=engine,
        messages=msg,
        response_format=struct_format,
...
class StructuredAzureEngine():
    ...
    def respond_structured(self, user_input, struct_format, temperature, top_p, max_tokens=20000):
        try:
