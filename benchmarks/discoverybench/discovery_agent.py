...
@click.option('--use_api', is_flag=True, help='Use API service instead of loading model directly')
@click.option('--api_base', default='http://localhost:8000', help='API service base URL')
